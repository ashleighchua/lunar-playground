...
export const products: Product[] = [
  {
    ...
    description: 'Your birth chart, decoded: your Big Three, your core drives, your decision-making style, and the patterns that shape your relationships, work, and growth.',
    price: '$5',
    priceAmount: 500,
    features: [
      'Big Three analysis (Sun, Moon, Rising)',
      'Core drives, decision-making style, and emotional patterns',
      'Relationship blueprint, work style, and growth edges',
      'A practical takeaways summary you can actually use',
    ],
