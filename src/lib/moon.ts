...
const moonPhaseData = [
  ...
  },
  {
    name: 'First Quarter',
    emoji: '🌓',
    description: 'You arrived at a turning point. First quarter souls know how to push through resistance. They are action-oriented, willing to make the difficult choice. You were born into momentum, into the tension between what was and what is becoming.'
  },
  {
    name: 'Waxing Gibbous',
    emoji: '🌔',
  ...
  },
  {
    name: 'Third Quarter',
    emoji: '🌗',
    description: 'You arrived at release. Third quarter souls understand endings. They are capable of letting go, clearing space for what comes next. You know, perhaps more than others, that completion is its own kind of beginning.'
  },
  {
...
const zodiacDetails: Record<string, Omit<ZodiacSign, 'name'>> = {
  ...
  Gemini: { symbol: '♊', element: 'Air', quality: 'Mutable', description: "Your spirit is curious, restless, endlessly hungry for new information and connections. You're here to learn, communicate, and weave ideas together in ways others can't see. Versatility is your gift, and you contain multitudes and see no reason to be just one thing. Life is a conversation, and you want to have all of it." },
  ...
  Leo: { symbol: '♌', element: 'Fire', quality: 'Fixed', description: "You're here to shine, create, and inspire. There's a natural radiance to your presence that draws others in. Generosity flows from you easily because you want everyone to feel as alive as you do. Your need for recognition isn't vanity; it's the honest desire to be seen for who you truly are. When you lead with your heart, you light up rooms." },
  ...
  Scorpio: { symbol: '♏', element: 'Water', quality: 'Fixed', description: "Your identity runs deep. You're here to transform yourself, situations, and sometimes the people around you. Surface-level existence doesn't interest you; you want truth, even when it's uncomfortable. There's an intensity to your presence that some find magnetic and others find unsettling. You're not afraid of the dark, because you know that's where the real treasure is buried." },
