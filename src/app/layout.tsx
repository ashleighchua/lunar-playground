            ...
            __html: JSON.stringify({
              ...
              hasOfferCatalog: {
                ...
                itemListElement: [
                  ...
                  { '@type': 'Offer', price: '5', priceCurrency: 'USD', itemOffered: { '@type': 'Service', name: 'Relocation Report', description: 'Your birth chart mapped across the globe to find cities that activate career, love, and transformation.' } },
                  { '@type': 'Offer', price: '5', priceCurrency: 'USD', itemOffered: { '@type': 'Service', name: 'Read Your Own Chart', description: 'A self-paced guide to reading your own relocation astrology chart.' } },
                ],
              },
            }),
          }}
