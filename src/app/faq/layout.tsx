...
const faqSchemaItems = [
  ...
  { q: 'What\'s the difference between the free tools and the paid readings?', a: 'The free tools give you automated results. The paid readings go deeper: calculated with Swiss Ephemeris, with every claim checked against your exact chart before it reaches you.' },
  ...
  { q: 'Who writes the readings?', a: 'Both are calculated with Swiss Ephemeris (the same tool real astrologers use), using a system Ashleigh built and designed herself, with every line checked against your real chart before it reaches you.' },
