...
export default function BaZiPage() {
  ...
  const renderPillarCell = (pillar: BaZiProfile['yearPillar'], label: string) => (
    <div className="flex flex-col text-center">
      <div className="text-xs tracking-widest uppercase text-[#7B7394] mb-3 pb-2 border-b border-[#2D2640]/10">
        {label}
      </div>
      <div className="py-3 border-b border-[#2D2640]/10">
        ...
        <div
          ...
          style={{ color: elementContent[pillar.stemElement]?.color || '#7B7394' }}
        >
          {pillar.stemElement}
        </div>
      </div>
      <div className="py-3">
        ...
        <div
          className="text-[10px] mt-1 font-medium uppercase tracking-wide"
          style={{ color: elementContent[pillar.branchElement]?.color || '#7B7394' }}
        >
        ...
        {showLoading ? (
            ...
            <section className="container-editorial pt-8 pb-12 md:pt-12 md:pb-16">
              <div className="max-w-2xl">
                ...
                <p className="mt-5 text-lg text-[#7B7394] leading-relaxed">
                  The ancient Chinese art of destiny analysis. Your birth date and time encode the Five Elements that shape your character, strengths, and life path.
                </p>
              </div>
            </section>
            ...
            <section className="container-editorial py-12 md:py-16 min-h-[55vh] flex items-center justify-center">
              <div className="max-w-md w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="bazi-birthdate" className="block text-sm text-[#7B7394] mb-2">
                      Date of birth
                    </label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label htmlFor="bazi-birthtime" className="block text-sm text-[#7B7394] mb-2">
                      Time of birth
                    </label>
                    <input
                      type="time"
                  ...
                  <div>
                    <label className="block text-sm text-[#7B7394] mb-3">
                      Gender
                    </label>
          ...
          <>
            ...
            <section className="container-editorial pt-8 pb-10 md:pt-12">
              ...
              <div>
                <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-3">Day Master</p>
                <h1 className="font-serif text-4xl md:text-5xl text-[#2D2640] leading-[1.1] tracking-tight">
                  {profile.dayMaster} {profile.dayMasterElement}
                </h1>
                <p className="mt-2 text-lg text-[#7B7394]">
                  {profile.dayMasterYinYang} · {dmContent.metaphor}
                </p>
                <p className="mt-5 text-base text-[#7B7394] leading-relaxed">
                  {dmContent.overview}
                </p>
              </div>
            </section>
            ...
            <section className="container-editorial py-12 md:py-14">
              ...
              <div className="mt-3 flex gap-6">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-[#7B7394]">Top row:</span>
                  <span className="text-xs text-[#2D2640]">Heavenly Stem</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-xs text-[#7B7394]">Bottom row:</span>
                ...
                <div className="blur-[3px] opacity-60">
                  <div className="py-12 md:py-14">
                    <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                      <div className="border border-[#2D2640]/10 rounded-lg p-6 md:p-8">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-3">Day Master Strength</p>
                      ...
                      <div className="border border-[#2D2640]/10 rounded-lg p-6 md:p-8">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-3">Favorable Elements</p>
                        <div className="flex flex-wrap gap-2 mb-4">
                          {profile.favorableElements.slice(0, 2).map((el) => (
                            <span
                              key={el}
                              className="px-3 py-1.5 rounded-full text-sm font-medium text-white"
                              style={{ backgroundColor: elementContent[el]?.color || '#7B7394' }}
                            >
                    ...
                    <div className="grid grid-cols-3 gap-4 md:gap-6 mt-6">
                      <div className="border border-[#2D2640]/10 rounded-lg p-5">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-3">Lucky Colors</p>
                        <p className="text-sm text-[#2D2640]">Revealed in full report</p>
                      </div>
                      <div className="border border-[#2D2640]/10 rounded-lg p-5">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-3">Directions</p>
                        <p className="text-sm text-[#2D2640]">Revealed in full report</p>
                      </div>
                      <div className="border border-[#2D2640]/10 rounded-lg p-5">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-3">Numbers</p>
                        <p className="text-sm text-[#2D2640]">Revealed in full report</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="py-12 md:py-14">
                    ...
                    <div className="border border-[#2D2640]/10 rounded-lg p-6 md:p-8 max-w-2xl">
                      <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-3">{profile.pattern}</p>
                      <p className="text-sm text-[#7B7394] leading-relaxed">
                  ...
                  <div className="py-12 md:py-14">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                      <div className="border border-[#2D2640]/10 rounded-lg p-6 md:p-8">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-4">Personality</p>
                        <p className="text-sm text-[#7B7394] leading-relaxed">Your core personality traits and natural tendencies are revealed through your Day Master.</p>
                      </div>
                      <div className="border border-[#2D2640]/10 rounded-lg p-6 md:p-8">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-4">Career</p>
                        <p className="text-sm text-[#7B7394] leading-relaxed">Your ideal career path and professional strengths are shaped by your elemental balance.</p>
                      </div>
                      <div className="border border-[#2D2640]/10 rounded-lg p-6 md:p-8">
                        <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-4">Relationships</p>
                        <p className="text-sm text-[#7B7394] leading-relaxed">How you connect with others and your relational patterns stem from your chart structure.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-[#F0E6D6] rounded-2xl p-8 md:p-12">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-lg text-[#7B7394] leading-relaxed max-w-lg mx-auto">
                        Your chart holds much more. The full reading interprets your pillars in detail and reveals how to work with your elemental balance.
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-[#7B7394]/60 mt-4">Or save with The Full Blueprint &mdash; $139</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="py-12 md:py-16 px-6">
              <div className="max-w-xl mx-auto">
                <div className="bg-[#E8E3F0] rounded-2xl p-8 md:p-10 text-center">
                  ...
                  <p className="text-[#7B7394] mb-8">Get your BaZi Four Pillars reading sent to your inbox.</p>
