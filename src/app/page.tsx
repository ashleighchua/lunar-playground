      ...
      <main className="flex-1">
        ...
        <section className="container-editorial pt-12 pb-8 md:pt-20 md:pb-12">
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xs uppercase tracking-widest text-[#7B7394] mb-4">A Playground, Not a Prophecy</p>
            ...
            <p className="mt-6 text-lg text-[#7B7394] leading-relaxed max-w-lg mx-auto">
              Six ancient systems. One birth date. A complete picture of your personality, purpose, timing, and direction. In minutes.
            </p>
          </div>
        </section>
        ...
        <section className="container-editorial py-12 md:py-16">
          <p className="text-xs uppercase tracking-widest text-[#7B7394] text-center mb-8">What clients say</p>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {featuredReviews.map((review) => (
              <div key={review.id} className="bg-white rounded-2xl border border-[#2D2640]/5 p-6">
                ...
                <p className="text-sm text-[#7B7394] leading-relaxed italic">
        ...
        <section className="container-editorial py-12 md:py-16">
          <div className="max-w-xl mx-auto text-center">
            <p className="text-lg text-[#7B7394] leading-relaxed italic mb-6">
            ...
            <Link
              href="/about"
              className="text-xs text-[#7B7394] hover:text-[#2D2640] transition-colors underline underline-offset-2"
            >
              Read my story
            </Link>
          </div>
