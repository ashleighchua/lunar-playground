      ...
      <main className="container-editorial py-16 md:py-24">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="prose prose-neutral max-w-none space-y-6 text-[#7B7394]">
            ...
            <section className="space-y-4">
              <h2 className="font-serif text-xl text-[#2D2640]">Important disclaimer</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-serif text-xl text-[#2D2640]">Your use of the site</h2>
            ...
            <section className="space-y-4">
              <h2 className="font-serif text-xl text-[#2D2640]">Limitation of liability</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-serif text-xl text-[#2D2640]">Intellectual property</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="font-serif text-xl text-[#2D2640]">Changes to terms</h2>
              <p>
