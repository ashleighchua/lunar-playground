...
export default function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="min-h-screen relative overflow-hidden text-[#F0E9DC]"
      style={{
        background: 'linear-gradient(180deg, #1A1628 0%, #2D2640 45%, #3D3656 100%)',
      }}
    >
      <div
        ...
        style={{
          backgroundImage: [
            ...
            'radial-gradient(1.5px 1.5px at 80% 15%, rgba(217,184,120,0.8), transparent)',
            ...
            'radial-gradient(1px 1px at 45% 65%, rgba(217,184,120,0.6), transparent)',
