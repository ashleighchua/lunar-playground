      ...
      <div className="p-6 md:p-8 pt-0 space-y-6">
        ...
        {motivationText && (
          <div className="bg-[#FAF7F2] rounded-xl p-5">
            ...
            <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-3">{motivationParagraphs[0]}</p>
            {motivationParagraphs[1] && <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-3">{motivationParagraphs[1]}</p>}
            {motivationParagraphs[2] && <p className="text-[#2A2A2A]/80 text-sm leading-relaxed italic">{motivationParagraphs[2]}</p>}
          </div>
        )}
        ...
        {ambitionText && (
          <div className="bg-[#FAF7F2] rounded-xl p-5">
            ...
            <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-3">{ambitionParagraphs[0]}</p>
            {ambitionParagraphs[1] && <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-3">{ambitionParagraphs[1]}</p>}
            {ambitionParagraphs[2] && <p className="text-[#2A2A2A]/80 text-sm leading-relaxed italic">{ambitionParagraphs[2]}</p>}
          </div>
        )}
        ...
        {authorityText && (
          <div className="bg-[#F5F3F0] rounded-xl p-5">
            ...
            <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-3">{authorityParagraphs[0]}</p>
            {authorityParagraphs[1] && <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-3">{authorityParagraphs[1]}</p>}
            {authorityParagraphs[2] && <p className="text-[#2A2A2A]/80 text-sm italic">{authorityParagraphs[2]}</p>}
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {environmentText && (
            <div className="bg-[#EDF4ED] rounded-xl p-5">
              ...
              <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-3">{environmentParagraphs[0]}</p>
              {environmentParagraphs[1] && <p className="text-[#2A2A2A]/80 text-sm leading-relaxed">{environmentParagraphs[1]}</p>}
            </div>
          )}
          ...
          {burnoutText && (
            <div className="bg-[#F5EBE8] rounded-xl p-5">
              ...
              <p className="text-[#2A2A2A]/80 text-sm leading-relaxed mb-4">{burnoutParagraphs[0]}</p>
              ...
              {burnoutParagraphs[2] && <p className="text-[#2A2A2A]/80 text-sm leading-relaxed">{burnoutParagraphs[2]}</p>}
            </div>
          )}
        </div>
          ...
          <div className="bg-[#F0EBE3] rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-serif text-lg text-[#2A2A2A] leading-relaxed mb-2">{checkInParagraphs[0]}</p>
                {checkInParagraphs[1] && <p className="text-[#6B6B6B] text-sm">{checkInParagraphs[1]}</p>}
              </div>
            </div>
          </div>
        )}
