        ...
        {checkInText && (
          <div className="bg-[#F0EBE3] rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs tracking-wider uppercase text-[#7B7394] mb-3">A useful check-in</p>
                <p className="font-serif text-lg text-[#2D2640] leading-relaxed mb-2">{checkInParagraphs[0]}</p>
                {checkInParagraphs[1] && <p className="text-[#7B7394] text-sm">{checkInParagraphs[1]}</p>}
              </div>
            </div>
          </div>
        )}
