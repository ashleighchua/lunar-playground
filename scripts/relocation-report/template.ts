 ...
 *
 * Renders a ReportContent object (fully authored copy + grounded facts) into
 * a single self-contained HTML document styled to match The Lunar
 * Playground's established relocation-report brand (see the two prior
 * client reports this was reverse-engineered from). render.ts prints this
 * to PDF via Puppeteer.
 */
